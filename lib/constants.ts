export const HOST = process.env.NEXT_PUBLIC_SERVER_URL || "http://localhost:8747";
export const SOCKET_HOST = process.env.NEXT_PUBLIC_SOCKET_URL || "http://localhost:4004";
