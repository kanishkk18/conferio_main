  ...
  const handleLocationTypeChange = async (value: VideoConferencingPlatform) => {
    ...
    if (value === VideoConferencingPlatform.GOOGLE_MEET_AND_CALENDAR) {
      ...
      try {
        ...
        if (!isConnected) {
          setError(
            `Google Meet is not connected. <a href="/integrations/page" target="_blank" class='underline text-primary'>Visit the integration page</a> to connect your account.`
          );
          return;
        }
        setError(null);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        ...
        <Button className="dark:bg-blue-600 bg-yellow-400 text-white">
