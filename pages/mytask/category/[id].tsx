...
import { Plus, Settings2Icon, XIcon, Trash } from "lucide-react";
  ...
  return (
    <div className="flex">
      <Mainsidebar />
       <SidebarProvider>
      <AppSidebar />
      <div className="absolute text-white text-center flex justify-center items-center left-16 top-3 ">
              ...
              <div className="flex items-center gap-2 py-2">
                <div className="space-y-2 w-full">
                  <div className="relative">
                    <Input id={Array.isArray(id) ? id[0] : id} className="peer pe-9 ps-9 py-6 rounded-3xl bg-[#161616]/90 border-none" placeholder="Search..." type="search" />
