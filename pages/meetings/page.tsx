  ...
  return (
    ...
    <div className="min-h-screen flex bg-gray-950 text-white">
      ...
      <div className=" ">
        ...
        <div className="grid grid-cols-12  gap-6  pl-8">
          {/* Main Dashboard Area (Left side - 9 columns) */}
          <div className="col-span-10 pt-24 lg:col-span-7">
      ...
      <div className="absolute inset-0">
        <svg width="100%" height="100%" className="opacity-10">
          <pattern id="pattern-zigzag" width="30" height="30" patternUnits="userSpaceOnUse">
            <path d="M0 15 L15 0 L30 15 L15 30 Z" fill="none" stroke="white" strokeWidth="1" />
          </pattern>
...
<h3 className="text-3xl font-semibold text-white -mt-2 mb-2 z-50 [text-shadow:_2px_2px_4px_rgba(0,0,0,0.6)]">
  Schedule <br /> a meeting
         ...
         <img className='rounded-t-[2.9rem] absolute -right-24' src="https://res.cloudinary.com/kanishkkcloud18/image/upload/v1747576462/CONFERIO/evmztakxitrunclugusx.png" alt="" />
                </div>
                <Button variant="secondary" className='text-sm px-2 py-1 mt-2'>Do it now</Button>
      </div>
    </div>
              </div>
            </div>
...
<ChartCard/>
                ...
                <div className=" h-full ">
                  <div className="px-4 py-2 flex bg-red-500 justify-between rounded-xl h-full flex-col">
                        <div className="flex justify-between items-center">
                          <h1 className="text-lg font-semibold [text-shadow:_2px_2px_4px_rgba(0,0,0,0.6)]">My recordings</h1>
                          <span className="text-sm text-white bg-black/70 rounded-full p-1"><ArrowUpRight className="h-5 w-5"/> </span>
                        </div>
                        ...
                        <div className="overflow-hidden h-12 w-12 flex justify-center items-center rounded-full ">
                         <Image height={1000} width={1000} className='h-full w-full object-cover' src="https://res.cloudinary.com/kanishkkcloud18/image/upload/v1747587960/CONFERIO/i8p54hqyfxgndcw2lkbt.png" alt="" />
                        </div>
                        </div>
                      </div>
                </div>
            ...
            <div className="min-w-full w-full gap-6 mt-2">
                <div className="flex justify-between items-center py-4 px-2">
                 <h3 className="text-2xl font-semibold text-white">Active Bookings</h3>

                 <Link href="/bookings/page" className='flex justify-center items-center gap-2'>
                 <Button variant="link" className="text-sm text-blue-500 hover:underline p-0">
                 View All</Button><ArrowRightIcon className='h-4 w-4'/></Link>
                 </div>
          ...
          {/* User Profile (Right side - 3 columns) */}
