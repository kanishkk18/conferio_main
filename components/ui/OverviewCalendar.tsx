...
function Calendar({
  ...
  return (
     <div className="pt-14 h-full dark w-fit mx-auto bg-black">
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square m-1 h-[70px] bg-[#101012] w-[70px] select-none p-2 rounded-lg text-start [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-md",
        ...
        today: cn(
          "bg-blue-600/70 text-accent-foreground rounded-md data-[selected=true]:rounded-none",
