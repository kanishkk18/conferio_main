  ...
  return (
    <div className=" py-10 bg-black">
       ...
       <span className='pr-8 ml-auto mr-20 space-y-4 text-center rounded-[16px] bg-[#121417] flex flex-col w-fit items-center justify-center '>
        <Image height={1000} width={1000} className='h-28 rounded-[16px]' src="https://res.cloudinary.com/kanishkkcloud18/image/upload/v1727771594/CONFERIO/bprqltttpgy3qffkkg5v.png" alt="" />
