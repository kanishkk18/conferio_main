  ...
  return (
      ...
      <div className="flex-1 overflow-y-scroll p-3 space-y-1 thin-scrollbar">
        ...
        <div className="space-y-1">
          <div className="flex justify-end">
            <div className="bg-[#3d01c5] text-white rounded-2xl py-2 px-3 max-w-[80%] text-sm">
              guess what Im in Seoul haha just caught this amazing sunset look!
            </div>
          </div>
          <div className="flex justify-end">
...
export function MusicPlayerExample() {
  ...
  return (
    <div className="flex flex-col items-center pt-4 ">
      <div className="flex space-x-1 border border-none rounded-[8px] cursor-pointer bg-neutral-700  px-[3px] py-[3px] shadow-inner-shadow">
        {tabs.map((tab, i) => (
          <button
            key={`${tab.id}-i-${i}`}
            ...
            } relative rounded-[5px] px-1 py-1 text-xs sm:text-sm font-medium text-neutral-600  transition focus-visible:outline-1 focus-visible:ring-1 focus-visible:ring-blue-light focus-visible:outline-none`}
